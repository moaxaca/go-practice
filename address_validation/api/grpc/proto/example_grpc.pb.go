...
type ExampleClient interface {
	Ping(ctx context.Context, in *ExampleRequest, opts ...grpc.CallOption) (*ExampleResponse, error)
}
...
func (c *exampleClient) Ping(ctx context.Context, in *ExampleRequest, opts ...grpc.CallOption) (*ExampleResponse, error) {
	out := new(ExampleResponse)
	err := c.cc.Invoke(ctx, "/Example/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedExampleServer) Ping(context.Context, *ExampleRequest) (*ExampleResponse, error) {
...
func _Example_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Example/Ping",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExampleServer).Ping(ctx, req.(*ExampleRequest))
	}
...
var Example_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/grpc/proto/example.proto",
}
